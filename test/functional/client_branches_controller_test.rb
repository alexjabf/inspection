...
class ClientBranchesControllerTest < ActionController::TestCase
  ...
  test "should create client_branch" do
    assert_difference('ClientBranch.count') do
      post :create, client_branch: { address1: @client_branch.address1, address2: @client_branch.address2, city: @client_branch.city, country: @client_branch.country, description: @client_branch.description, email1: @client_branch.email1, email2: @client_branch.email2, fax: @client_branch.fax, name: @client_branch.name, phone1: @client_branch.phone1, phone2: @client_branch.phone2, state: @client_branch.state, webpage: @client_branch.webpage, zip: @client_branch.zip }
    end
  ...
  test "should update client_branch" do
    put :update, id: @client_branch, client_branch: { address1: @client_branch.address1, address2: @client_branch.address2, city: @client_branch.city, country: @client_branch.country, description: @client_branch.description, email1: @client_branch.email1, email2: @client_branch.email2, fax: @client_branch.fax, name: @client_branch.name, phone1: @client_branch.phone1, phone2: @client_branch.phone2, state: @client_branch.state, webpage: @client_branch.webpage, zip: @client_branch.zip }
    assert_redirected_to client_branch_path(assigns(:client_branch))
  end
