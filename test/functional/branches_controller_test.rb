...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { address1: @branch.address1, address2: @branch.address2, city: @branch.city, country: @branch.country, description: @branch.description, email1: @branch.email1, email2: @branch.email2, name: @branch.name, name: @branch.name, phone1: @branch.phone1, phone2: @branch.phone2, state: @branch.state, webpage: @branch.webpage, zip: @branch.zip }
    end
