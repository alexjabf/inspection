class RoutesHistory < ActiveRecord::Base
  ...
  attr_accessible :closed, :final_km, :finished_at, :initial_km, :started_at, :weekday, :driver_id, :start_latitude, :start_longitude, :end_latitude, :end_longitude, :branch_id, :company_id, :schedule_id
